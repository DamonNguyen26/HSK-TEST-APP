...
class SpeedGameManager {
    ...
    checkAnswer(selected, correct) {
        ...
        this.userHistory.push({
            ...
            realMeaning: correct.meaning || correct.english // THÊM BIẾN LƯU NGHĨA GỐC
        });
            ...
            if (this.timeLeft <= 0) {
                ...
                for(let i = this.currentIndex; i < this.gameWords.length; i++) { 
                    ...
                    this.userHistory.push({
                        ...
                        realMeaning: w.meaning || w.english // THÊM BIẾN LƯU NGHĨA GỐC
                    });
                }
                this.endGame();
            }
        ...
        this.timer = setInterval(() => {
            ...
            if (this.timeLeft <= 0) {
                ...
                this.userHistory.push({
                    ...
                    correctMeaning: displayCorrect, selectedMeaning: "⏳ Hết giờ", isCorrect: false, quizType: this.quizType,
                    realMeaning: currentWord.meaning || currentWord.english // THÊM BIẾN LƯU NGHĨA GỐC
                });
                this.currentIndex++;
                this.renderQuestion();
            }
    ...
    endGame() {
        ...
        if (wrongAnswers.length === 0) {
            ...
            wrongAnswers.forEach(item => {
                ...
                // LẤY BIẾN realMeaning RA ĐỂ HIỂN THỊ CHUẨN TIẾNG VIỆT
